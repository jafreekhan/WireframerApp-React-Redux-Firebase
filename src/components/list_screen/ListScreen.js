                        ...
                        <div className="wireframe properties">
                            ...
                            <div className="padding_20 col">
                                <div className="input-field col s6">
                                    ...
                                    <input className="text_20" type="text" name="name" id="name" onChange={this.handleChange} defaultValue={"Null"} />
                                </div>
                                <div className="input-field col s6">
                                    <label className="active text_16" htmlFor="name">Font Size</label>
                                    <input className="text_20" type="text" name="name" id="name" onChange={this.handleChange} defaultValue={"0"} />
                                </div>
                                <div className="input-field col s6">
